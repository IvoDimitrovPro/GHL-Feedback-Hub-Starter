# MR-144 — Keep separate-track exports out of the core recording workflow
...
## Observed
The initial beta feedback proposed exporting separate logical audio tracks from a recording.
...
## Resolution
Closed — Not pursuing, at Ivo's direction. The audio-only export and AI-ready transcript use case is tracked independently in MR-145.
